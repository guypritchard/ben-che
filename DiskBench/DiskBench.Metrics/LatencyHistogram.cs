...
public sealed class LatencyHistogram
{
    ...
    /// </summary>
    public long SumTicks => _sum;

    /// <summary>
    /// Gets the minimum recorded latency in ticks.
    /// </summary>
    public long MinTicks => _count > 0 ? _minTicks : 0;
    ...
    /// </summary>
    public double MeanTicks => _count > 0 ? (double)_sum / _count : 0;
    ...
    public long GetPercentileTicks(double percentile)
    {
        ...
        long targetCount = (long)(percentile * _count);
    ...
    {
        return GetPercentileTicks(percentile);
    }
    ...
    public void Merge(LatencyHistogram other)
    {
        ...
        _count += other._count;
        _sum += other._sum;
        if (other._minTicks < _minTicks) _minTicks = other._minTicks;
        if (other._maxTicks > _maxTicks) _maxTicks = other._maxTicks;
    }
