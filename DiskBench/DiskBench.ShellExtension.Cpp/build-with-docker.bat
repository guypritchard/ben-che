...
if exist "DiskBench\DiskBench.ShellExtension.Cpp\bin\Release\DiskBench.ShellExtension.Cpp.dll" (
    echo.
    echo ============================================
    echo SUCCESS! DLL built successfully
    echo ============================================
    echo.
    echo Location: DiskBench\DiskBench.ShellExtension.Cpp\bin\Release\DiskBench.ShellExtension.Cpp.dll
    echo.
    echo Next steps:
